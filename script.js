// ✅ Correction complète avec Firebase et exposition des fonctions globales
...
btn.innerHTML =       <img src="${q.imagesAnswers[index]}" alt="${answer}" />
      <span>${answer}</span>
   ;
...
stats.innerHTML =     <p><strong>📊 Stats de ta partie :</strong></p>
...
lb.innerHTML = "Rang | Avatar | Pseudo | Score | Temps moyen";
...
// 🔓 Rendre utilisables depuis le HTML
